...
def fetch_common_package_data():
    try:
        print("downloading common_package_data_for_all_newjumpunpaywall.json.gz")
        s3_clientobj = s3_client.get_object(Bucket="unsub-cache", Key="common_package_data_for_all_newjumpunpaywall.json.gz")
