...
# all with prefix 'test_consortium_bindvars_'
def test_consortium_bindvars_get_latest_member_institutions_raw():
...
def test_consortium_bindvars_consortium_get_computed_data():
...
def test_consortium_bindvars_consortium_get_issns():
...
def test_consortium_bindvars_all_member_package_ids():
...
def test_consortium_bindvars_to_dict_journal_zoom():
...
def test_consortium_bindvars_get_perpetual_access_from_cache():
