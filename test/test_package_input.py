...
class TestPackageInput(unittest.TestCase):
    ...
    def test_normalize_price(self):
        ...
        assert_equals(PackageInput.normalize_price('1.000'), 1)
        assert_equals(PackageInput.normalize_price('   $100,51'), 101)
        assert_equals(PackageInput.normalize_price('5341.1849999999995'), 5341)
        assert_equals(PackageInput.normalize_price('3196.845'), 3197)
        assert_equals(PackageInput.normalize_price('10684.935'), 10685)
        assert_equals(PackageInput.normalize_price('10684,935'), 10685)
        assert_equals(PackageInput.normalize_price('643.815'), 644)
        assert_equals(PackageInput.normalize_price('$10,325.20'), 10325)
